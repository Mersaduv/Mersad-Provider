      ...
      <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group relative cursor-pointer">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center pt-3 border-t border-gray-100">
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium px-4 py-2 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md inline-flex items-center">
