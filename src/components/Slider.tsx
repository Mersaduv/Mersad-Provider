              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white px-4">
                  ...
                  {slider.link && (
                    <Link
                      href={slider.link}
                      className="inline-block bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-full hover:bg-white/30 transition-all duration-300 border border-white/30"
                    >
                      مشاهده بیشتر
                    </Link>
                  )}
