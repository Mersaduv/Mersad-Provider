...
export const metadata: Metadata = {
  title: "درباره ما - شرکت مرصاد لمیتد",
  description:
    "شرکت مرصاد لمیتد با سال‌ها تجربه در زمینه تجارت لمیتد، ارائه‌دهنده بهترین خدمات و محصولات با کیفیت به مشتریان خود است",
  keywords: ["درباره ما", "شرکت مرصاد لمیتد", "تجارت", "لمیتد", "کیفیت"], 
  openGraph: {
    title: "درباره ما - شرکت مرصاد لمیتد",
    description: "شرکت مرصاد لمیتد با سال‌ها تجربه در زمینه تجارت لمیتد",
    type: "website",
    locale: "fa_IR",
  },
  twitter: {
